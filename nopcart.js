...
function ManageCart( ) {
   ...
   if ( bDisplay ) {
      ...
      if ( DisplayShippingRow ) {
         ...
         strOutput += "<TD CLASS=\"noptotal\" COLSPAN=1><B>" + strShipping + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }
      ...
      if ( DisplayTaxRow || TaxByRegion ) {
         if ( TaxByRegion ) {
            ...
            strOutput += "<TR><TD CLASS=\"noptotal\" COLSPAN=1><B>"+strTAX+"</B></TD>";
            strOutput += "<TD CLASS=\"noptotal\" COLSPAN=1><B>" + strTax + MonetarySymbol + "</B></TD>";
            strOutput += "</TR>";
         }
      }
      ...
      if ( !TaxByRegion ) {
         ...
         strOutput += "<TD CLASS=\"noptotal\" COLSPAN=1><B>" + moneyFormat((fTotal + fShipping + fTax)) + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }
      strOutput += "</TABLE>";
